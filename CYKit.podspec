...
Pod::Spec.new do |s|
  ...
  s.name         = "CYKit"
  s.version      = "0.0.1"
  s.summary      = "something using for daily develop"
  ...
  # Or just: s.author    = "chengyan"
  # s.authors            = { "chengyan" => "ab364743113@126.com" }
  # s.social_media_url   = "http://twitter.com/chengyan"
